       ...
       if(carros[i].abc <= 9){
			...
			case 2:
				 for(x=0; x<i; x++){
                    ...
                    printf("\nA marca do veículo é: %s",carros[x].marca);
				    printf("\nO modelo do veículo é: %s",carros[x].modelo);
                    printf("\nO ano do veículo é: %d",carros[x].ano);
                    printf("\nA placa do veículo é: %s",carros[x].placa);
                   printf("\n\n ========//======== \n \n");
				   }
                	break;
...
while (abc!=5 && i<=9);
 ...
 printf("\nA marca do veículo é: %s",carros[y].marca);

 printf("\nO modelo do veículo é: %s",carros[y].modelo);

 printf("\nO ano do veículo é: %d",carros[y].ano);

 printf("\nA placa do veículo é: %s",carros[y].placa);
